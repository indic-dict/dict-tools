...
/**
  * Example invocation:
  * java -jar bin/artifacts/dict-tools.jar install --destinationPath=/opt/dicts/stardict/ --dictRepoIndexUrl=https://raw.githubusercontent.com/indic-dict/stardict-index/master/dictionaryIndices.md
  */
